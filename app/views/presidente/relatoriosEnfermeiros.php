...
<html lang="pt-Br">
    ...
    <head>
        ...
        <title>Relatório sobre  Enfermeiros</title>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="logo text-center">
                            <h1>Relatório sobre  Enfermeiros</h1>
                        </div>
                    </div>
                </div>
            </div>
 ...
 <div class="mainbody-section text-center bootstrap-iso">
    <div class="container">
        <div class="row">
            ...
            <form method="POST" action="../../controllers/administrador/obterRelatoriosEnfermeiro.php">
                 
                 <div class="form-group ">
                  <label class="control-label requiredField" for="letraInicial">
                   Digite uma Letra para obter os Enfermeiros :
                  ...
                  <label class="control-label " for="obterEstado">
                   OU selecione um Estado para obter os Enfermeiros:
                   <span class="asteriskField">
                    *
                   </span>
                  </label>
                 ...
                 <div class="form-group ">
                  <label class="control-label requiredField" for="obterPais">
                   OU digite um país para obter os Enfermeiros:
                   <span class="asteriskField">
                    *
                   </span>
                  </label>
