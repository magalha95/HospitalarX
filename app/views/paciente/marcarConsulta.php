...
<!-- HTML Form (wrapped in a .bootstrap-iso div) -->
 <div class="mainbody-section text-center bootstrap-iso">
    <div class="container">
        <div class="row">
            <form method="POST" action="../../controllers/paciente/marcaConsulta.php">
                 
                 <div class="form-group ">
                  <label class="control-label requiredField" for="tipoConsulta">
                   Tipo Consulta
                   <span class="asteriskField">
                    *
                   </span>
                  </label>
                  <input class="form-control" id="tipoConsulta" name="tipoConsulta" placeholder="Digite um tipo..." type="text"/>
                 </div>
             
                 <div class="form-group ">
                  <label class="control-label " for="dataConsulta">
                   Data Consulta
                   <span class="asteriskField">
                    *
                   </span>
                  </label>
                  <input class="form-control date" id="dataConsulta" name="dataConsulta" placeholder="MM/DD/YYYY" type="text"/>
                 </div>
